...
My main research interests in the system and ``` diff @@ computational neuroscience, Deep learning, and  machine learning.@@ ``` As a side-work, I have been a member of HiBrainy working on some industrial projects including (TTS)Text-To-Speech, face anti-spoofing, liveness detection, head pose estimation, face depth estimation, and face emotion detection. 
